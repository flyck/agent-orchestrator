...
-- OR types a free-form label into the navbar. The label is filled in
-- asynchronously by an LLM one-shot for task-attributed switches and
-- is the user-typed string for manual ones (task_id is NULL).
